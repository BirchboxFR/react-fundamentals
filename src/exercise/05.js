...
const Box = ({size, style, children}) => {
  ...
  return (
    <div className={`box ${sizeClassName}`} style={{...style, fontStyle: "italic"}}>{children}</div>
  );
}
...
function App() {
  return (
    <div>
      <Box size="small" style={{backgroundColor: "lightblue", fontStyle: "normal"}}>small lightblue box</Box>
